...
const femaleMatches = [
    { name: 'Ananya Sen', age: 22, city: 'Mumbai', bio: 'Bandra indie musician, coffee collector, and techno lover 🎸☕', avatar: '✨', score: '98%', comp: 'Shared Interests: Both love serious relationships & spontaneous long drives 🚗' },
    { name: 'Riya Mehta', age: 24, city: 'Mumbai', bio: 'Product designer at a startup. Always up for secret food trails 🍣🎨', avatar: '💘', score: '95%', comp: 'Shared Chemistry: Both love Bandra indie acoustics & weekend coffee runs ☕' },
    { name: 'Tara D’Souza', age: 23, city: 'Mumbai', bio: 'Weekend road-tripper, amateur astronomer, and pure ambivert ⚖️🌌', avatar: 'rose-symbol', score: '93%', comp: 'Matching Vibes: Ambient dreamers who value active listening & slow dates 🕯️' }
];

const maleMatches = [
    { name: 'Kabir Kapoor', age: 23, city: 'Mumbai', bio: 'Jazz keyboardist, cafe reader, and coffee brewer 🎹☕', avatar: '✨', score: '98%', comp: 'Shared Chemistry: Both love Bandra indie acoustics & weekend coffee runs ☕' },
    { name: 'Aarav Mehta', age: 25, city: 'Mumbai', bio: 'Architectural photographer. High-energy techno enthusiast 🌃📸', avatar: '👑', score: '94%', comp: 'Shared Interests: Both love serious relationships & spontaneous long drives 🚗' },
    { name: 'Ishaan Verma', age: 22, city: 'Mumbai', bio: 'Hiking lover, spontaneous planner, and dog dad 🐾⛰️', avatar: '💎', score: '92%', comp: 'Mutual Preferences: Techno enthusiasts who love midnight drives & local chats 🌃' }
];
...
function parseUrlAndLoadConversation() {
    ...
    const targetMatch = window._inboxConnections.find(m => m.name.toLowerCase() === activeMatchName.toLowerCase() || m.name.split(' ')[0].toLowerCase() === activeMatchName.toLowerCase());
